...
class MultiplyTwoCardTest {
    ...
    MultiplyTwoCard multi = new MultiplyTwoCard();
    ...
    void testATutto(){
        ...
        assertEquals(2400, multi.calScores(aTuttoPair));
    }
    ...
    void testNotTutto(){
        ...
        aPairOfDice.add(5);
        assertEquals(1050, multi.calScores(aPairOfDice)); // 1000+200+200=1400
    }

    @Test
    void testTuttoDefault(){
        assertFalse(multi.ableToDrawAnotherCard());
    }
    ...
    void testATurn(){
        ...
        ArrayList<Integer> resultDices = multi.handleTurn();
